    ...
    return (
      <div className="">
        ...
        <form className="form-horizontal" onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
          ...
          <Field name="manipulator" component={this.renderField} type="text" label={action == 1 ? "被背书人" : "背书人" }/>
          ...
          <Field name="endorsor" component={this.renderField} type="text" label={action == 1 ? '背书人' : '被背书人'}/>
          <div className="row">
...
}, {prompt_endorsement})(reduxPromptEndorsementForm);