      ...
      <div className="">
        ...
        <form className="form-horizontal" onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
          ...
          {action!=1 && <div>
            ...
            <Field name="money" component={this.renderField} type="text" label='实付金额'/>
          </div>}
          <div className="row">
...
const selector = formValueSelector('PromptDiscountForm');

const reduxPromptDiscountForm = reduxForm({
  form: 'PromptDiscountForm',
  validate
})(PromptDiscount);
